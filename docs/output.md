...
- `${datatype}/${specimen}`
  - `${run}/`
    ...
    - `${assembly}.${datatype}.${specimen}.${run}.${aligner}.coverage.${coverage_binsize/1000}k.bedGraph.gz`: Read coverage in bedGraph format
    - `qc/`
  ...
  - `merged_${#}/` (optional if `params.merged_output` is specified)
    ...
    - `${assembly}.${datatype}.${specimen}.merged_${#}.${aligner}.coverage.${coverage_binsize/1000}k.bedGraph.gz`: Read coverage for merged file
    - `stats/`
...
- `read_mapping`
  - `ont/${specimen}`
    - `${run}/`
      ...
      - `${assembly}.ont.${specimen}.${run}.${aligner}.coverage.${coverage_binsize/1000}k.bedGraph.gz`: Read coverage in bedGraph format
...
- `read_mapping`
  - `pacbio/${specimen}`
    - `${run}/`
      ...
      - `${assembly}.pacbio.${specimen}.${run}.${aligner}.coverage.${coverage_binsize/1000}k.bedGraph.gz`: Read coverage in bedGraph format
    - `merged_${#}/` - if params `merge_output`.
...
**File naming:** `${assembly}.${type}.${specimen}.${run}.${aligner}.coverage.${coverage_binsize/1000}k.bedGraph.gz`
