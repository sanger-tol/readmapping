...
- `read_mapping`
  ...
  - `ont`
    - `merged`
      ...
      - `<gca_accession>.unmasked.ont.<sample_id>.flagstat.gz`: Number of alignments for each FLAG type
      - `<gca_accession>.unmasked.ont.<sample_id>.idxstats.gz`: Merged alignment summary statistics
    - `<gca_accession>.unmasked.ont.<sample_id>_T<number>.stats.gz`: Comprehensive statistics from each alignment file
    - `<gca_accession>.unmasked.ont.<sample_id>_T<number>.flagstat.gz`: Number of alignments for each FLAG type
    - `<gca_accession>.unmasked.ont.<sample_id>_T<number>.idxstats.gz`: Alignment summary statistics
  - `pacbio`
    - `merged`
      - `<gca_accession>.unmasked.pacbio.<sample_id>.stats.gz`: Comprehensive statistics from alignment file
      - `<gca_accession>.unmasked.pacbio.<sample_id>.flagstat.gz`: Number of merged alignments for each FLAG type
      - `<gca_accession>.unmasked.pacbio.<sample_id>.idxstats.gz`: Merged alignment summary statistics
    - `<gca_accession>.unmasked.pacbio.<sample_id>_T<number>.stats.gz`: Comprehensive statistics from each alignment file
    - `<gca_accession>.unmasked.pacbio.<sample_id>_T<number>.flagstat.gz`: Number of alignments for each FLAG type
    - `<gca_accession>.unmasked.pacbio.<sample_id>_T<number>.idxstats.gz`: Alignment summary statistics
