...
## [[v2.1.0](https://github.com/sanger-tol/readmapping/releases/tag/2.1.0)] - Chinese Fireball - [2026-09-11]
...
| `multiqc`      | 1.33        | 1.35              |
| `samtools`     | 1.23.1      | 1.23.1 and 1.24.0 |
...
- Chaining command to avoid ambiguous error if samtools/merge fail (#239)

## [[v2.0.1](https://github.com/sanger-tol/readmapping/releases/tag/2.0.1)] - Hungarian Horntail (patch 1) - [2026-04-30]

### Enhancements & fixes

- Removed ".unmasked" from output file names

## [[v2.0.0](https://github.com/sanger-tol/readmapping/releases/tag/2.0.0)] - Hungarian Horntail - [2026-04-27]
