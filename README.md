...
**sanger-tol/readmapping** is a bioinformatics best-practice analysis pipeline for map reads to genome.
...
4. Start running your own analysis!
   ...
   ```bash
   nextflow run sanger-tol/readmapping --input samplesheet.csv --outdir <OUTDIR> --genome GRCh37 -profile <docker/singularity/podman/shifter/charliecloud/conda/institute>
   ```
