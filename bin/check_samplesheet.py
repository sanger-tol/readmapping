    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            lib_col (str): The name of the column that contains the library
                information for the data (default "library").
...
def check_samplesheet(file_in, file_out):
    ...
    .. _readmapping samplesheet:
        https://raw.githubusercontent.com/sanger-tol/readmapping/main/assets/samplesheet.csv
